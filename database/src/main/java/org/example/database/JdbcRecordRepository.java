        ...
        try (Connection conn = DbConnectionManager.getConnection();
            ...
            for (int i = 1; i <= columnCount; i++) {
                if (meta.getColumnName(i).equalsIgnoreCase("id"))
                    hasId = true;
                if (meta.getColumnName(i).equalsIgnoreCase("label"))
                    hasLabel = true;
            }
                        ...
                        try {
                            ...
                            switch (colName) {
                                ...
                                case "num_hrefs":
                                    colName = "a_h";
                                    break;
                                case "n_unique_tokens":
                                    colName = "t_r";
                                    break;
                                case "average_token_length":
                                    colName = "w_l";
                                    break;
                                case "global_subjectivity":
                                    colName = "a_s";
                                    break;
                                case "global_sentiment_polarity":
                                    colName = "a_e";
                                    break;
                                case "title_subjectivity":
                                    colName = "t_s";
                                    break;
                                case "title_sentiment_polarity":
                                    colName = "t_e";
                                    break;
                                case "rate_positive_words":
                                    colName = "p";
                                    break;
                                case "shares":
                                    colName = "s";
